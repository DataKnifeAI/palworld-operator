...
<body>
  ...
  <main>
    ...
    <section id="overview" class="panel active" role="tabpanel">
      <p class="lede">Live pulse from Palworld REST on localhost — <code>/info</code>, <code>/metrics</code>, <code>/players</code>. RCON is deprecated; use REST.</p>
      <p class="lede">Official API: <a href="https://docs.palworldgame.com/api/rest-api/palwold-rest-api">palwold-rest-api</a> (Pocketpair’s spelling).</p>
    ...
    <section id="controls" class="panel" role="tabpanel">
      <p class="lede">Announce and save stay on the pod via REST. REST is not public-routed.</p>
