...
- [x] Opt-in `spec.serverManager` (`spec.modManager` alias) Server Manager on Gateway VIP (stats, REST controls, save zip, mods, basic auth, path sandbox, Recreate restart)
